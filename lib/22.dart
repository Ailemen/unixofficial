...
class frontbuyer22 extends StatefulWidget {
  const frontbuyer22({Key? key}) : super(key: key);

  @override

  State<frontbuyer22> createState() => _frontbuyer22State();
}
...
FirebaseFirestore.instance.collection('market').orderBy('time');
...
class _frontbuyer22State extends State<frontbuyer22> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        floatingActionButton: FloatingActionButton(
          child: Icon(Icons.flash_on_rounded, color: Colors.yellow,),
          onPressed: () {
    ...
    children: [
    Text("Looking for goods or service ? "
    "contact us at 'unixcareofficial@gmail.com' "
        ...
        letterSpacing: -0.5),
          ...
          //  Navigator.push(
            //    context,
            //    MaterialPageRoute(
              //      builder: (context) => marketpageedit()));
          },
          elevation: 0,
